...
# Add project root to sys.path to allow proper imports
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..')))

from model_traning.train_steering_angle import driving_data
...
if __name__ == "__main__":
    LOG_DIR = 'model_traning/train_steering_angle/save'
    LOGS_PATH = 'model_traning/train_steering_angle/logs' 
    EPOCHS = 30
    BATCH_SIZE = 100
    ...
    print("Run the command line:\n" \
          "--> tensorboard --logdir=model_traning/train_steering_angle/logs " \
